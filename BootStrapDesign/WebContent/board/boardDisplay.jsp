...
<div class="container-fluid p-0">
	<section class="resume-section p-3 p-lg-5 d-flex d-column" id="about" style="background-color: #f5f5dc">
		<div class="container">
			...
			<div align="right">
				<button class="btn btn-default" type="button" onclick="location.href='./form_board.jsp'">글쓰기</button>
				<button class="btn btn-default" type="button" onclick="location.href='../main.do'">메인화면</button>
			</div>
			<hr>
			...
			<table id="example" class="table table-striped table-bordered"
				...
				List<Board> boardList = 
					(List<Board>)session.getAttribute("boardList");
				%>		
				<thead>		
				<tr>
					<th>게시글번호</th>
				...
				<tr>
					<td>${x.getBno()}</td>
					<td>${x.getMid()}</td>
					<td><a href="boardRead.do?bno=${x.getBno()}">
					${x.getBtitle()}</a></td>
					<td>${x.getBdate()}</td>
					<td>${x.getBhit()}</td>
				</tr>				

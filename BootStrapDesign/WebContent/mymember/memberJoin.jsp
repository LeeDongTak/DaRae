...
<div class="container-fluid p-0">
	<section class="resume-section p-3 p-lg-5 d-flex d-column" id="about" style="background-color: #f5f5dc">
		<div class="container">
			<h1 class="text-center">HomeBook에 오신것을 환영합니다</h1>
			<div align="right">
			...
			<hr>
			<form class="navbar-form" name="login_form" action="memberjoin.do" method="POST">
				<table class="table">
					<tr>
						<th style="vertical-align: middle; font-size: 50px;" class="text-center" rowspan="7">회원가입</th>
						<td>
							<input class="form-control" type="text" name="mid" placeholder="ID">
						</td>
					</tr>
					<tr>
						<td>
							<input class="form-control" type="text" name="mname" placeholder="NAME">
										...
										<tr>
						<td>
							<input class="form-control" type="password" name="mpassword" placeholder="PASSWORD">
						</td>
					</tr>
										<tr>
						<td>
							<input class="form-control" type="password" name="mpassword2" placeholder="PASSWORD확인">
						</td>
					</tr>
										<tr>
						<td>
							<input class="form-control" type="text" name="mphone" placeholder="PHONENUMBER">
						</td>
					</tr>
										<tr>
						<td>
							<input class="form-control" type="date" name="mjoinDate" placeholder="가입날짜">
						</td>
					</tr>
					<tr>

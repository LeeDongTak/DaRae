...
<div class="container-fluid p-0">
	<section class="resume-section p-3 p-lg-5 d-flex d-column" id="about" style="background-color: #f5f5dc">
		<div class="container">
			<h1 class="text-center"><%=vo.getMname() %>님의 회원정보</h1>
			<div align="right">
			...
			<hr>
			<form class="navbar-form" name="login_form" action="memberInforAdjust.do" method="POST">
				<table class="table">
					<tr>
						<th style="vertical-align: middle; font-size: 50px;" class="text-center" rowspan="7">회원가입</th>
						<td>
							<input class="form-control" type="hidden" name="mid" value="<%=vo.getMid() %>">
							<%=vo.getMid()%>
						</td>
					</tr>
					<tr>
						<td>
							<input class="form-control" type="text" name="mname" value="<%=vo.getMname()%>">
						</td>
					</tr>
					<tr>
						<td>
							<input class="form-control" type="password" name="mpassword" value="<%=vo.getMpassword()%>">
						</td>
					</tr>
					<tr>
						<td>
							<input class="form-control" type="text" name="mphone" value="<%=vo.getMphone()%>">
						</td>
					</tr>
					<tr>
						<td>
							<input class="form-control" type="date" name="mjoinDate" value="<%=vo.getMjoinDate() %>">
						</td>
					</tr>
					<tr>
